    ...
    public class NoLineEntryRenderer : EntryRenderer
    {
        protected override void OnElementChanged(ElementChangedEventArgs<Entry> e)
        {
            ...
            if (Control != null)
            {
                ...
                var view = (Element as NoLineEntry);
                if (view != null)
                {
                    DrawBorder(view);
                    SetFontSize(view);
        ...
        void SetFontSize(NoLineEntry view)
        {
        ...
        void SetPlaceholderTextColor(NoLineEntry view)
        {
